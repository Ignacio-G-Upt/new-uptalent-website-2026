...
export const SizeBigHierarchy = ({ className }) => {
  return (
    <div
      className={`inline-flex items-center justify-center gap-2 px-7 py-4 relative bg-[#ec3a4b] rounded-[999px] overflow-hidden shadow-[0px_1px_2px_#0a0c120d] ${className}`}
    >
