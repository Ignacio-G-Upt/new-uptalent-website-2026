...
export const SizeBigHierarchySecondaryStrokeStateHover = ({ className }) => {
  return (
    <div
      className={`inline-flex items-center justify-center gap-2 px-7 py-4 relative rounded-[999px] overflow-hidden border border-solid border-[#b9b9cb] shadow-[0px_1px_2px_#0a0c120d] ${className}`}
    >
